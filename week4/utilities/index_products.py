...
def add_embedding_names(docs, names, model):
    embedding_names = model.encode(names)
    #print(embedding_names)
    for doc, emb_name in zip(docs, embedding_names):
        doc['_source']['embedding'] = emb_name.tolist()
    return docs
...
def index_file(file, index_name, reduced=False):
    ...
    for child in children:
        ...
        if docs_indexed % 200 == 0:
            ...
            docs = add_embedding_names(docs, names, model)
